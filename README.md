...
Static landing site for `くらしと仕事の研究室`.

The initial preview uses `noindex, nofollow, noarchive` and `robots.txt` to request that search engines do not index it. This is not access control: anyone with the URL can still view a public GitHub Pages site.

## Publish on GitHub Pages

1. Create a **public** repository named `kurashi-work-lab`.
